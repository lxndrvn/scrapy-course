...
class EplanningSpider(Spider):
    ...
    def parse_items(self, response):
        ...
        if 'display: inline; visibility: visible;' in agent_button:
            ...
            address_second = response.xpath('//tr[th="Address:"]/following-sibling:tr/td/text()').extract_first()
            ...
            self.logger.info('Agent button not found on the page, passing invalid url.')
